...
use rusqlite::{CachedStatement, MappedRows, Row};
use size::Size;

use crate::{
    StorePath, path_to_canonical_string,
    store::{
        StoreBackend,
        db_common::{self},
        queries,
...
impl<'a> StoreBackend<'a> for LazyDBConnection<'_> {
    ...
    fn query_system_derivations(
        ...
        self.execute_row_query_with_path(queries::QUERY_SYSTEM_DERIVATIONS, system, |row| {
