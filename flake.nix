{
  ...
  inputs = {
    ...
    nix-cachyos-kernel = {
      url = "github:xddxdd/nix-cachyos-kernel/7ce7e8689129da05517a41209a9d1ed3b86cb9e0";
      inputs = {
    ...
    zen-browser = {
      url = "github:0xc000022070/zen-browser-flake/2b7fec6557495d97736f1b31904f79312671ca2a";
      inputs = {
        nixpkgs.follows = "nixpkgs";
