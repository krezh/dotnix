{
  ...
  inputs = {
    ...
    nix-cachyos-kernel = {
      url = "github:xddxdd/nix-cachyos-kernel/5456ebc0442974babe3dcce3a30ca3a725b4dadd";
      inputs = {
    ...
    zen-browser = {
      url = "github:0xc000022070/zen-browser-flake/1b16ef2b81078b5f363e6bb689d2193f8eccadb7";
      inputs = {
        nixpkgs.follows = "nixpkgs";
