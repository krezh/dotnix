{
  ...
  inputs = {
    ...
    nix-cachyos-kernel = {
      url = "github:xddxdd/nix-cachyos-kernel/a5ace2f11c9bdae25e53d8617f7985a1c895ddae";
      inputs = {
    ...
    zen-browser = {
      url = "github:0xc000022070/zen-browser-flake/975870eb40a0cb6dc1baf6d63a704f9cfd5d4f27";
      inputs = {
        nixpkgs.follows = "nixpkgs";
