{
  ...
  inputs = {
    ...
    nix-cachyos-kernel = {
      url = "github:xddxdd/nix-cachyos-kernel/679cbad52fdcce02d342926e3db6bbaa776058e1";
      inputs = {
    ...
    zen-browser = {
      url = "github:0xc000022070/zen-browser-flake/6abd9c70a29f47fb1dda33c712cf4a305e5b31ac";
      inputs = {
        nixpkgs.follows = "nixpkgs";
