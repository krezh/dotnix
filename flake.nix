{
  ...
  inputs = {
    ...
    nix-cachyos-kernel = {
      url = "github:xddxdd/nix-cachyos-kernel/01308a5fc051717fe68733b92359d6611b474d9e";
      inputs = {
    ...
    zen-browser = {
      url = "github:0xc000022070/zen-browser-flake/6be82ac04e6713849ae23ec45cd606d96f3174d7";
      inputs = {
        nixpkgs.follows = "nixpkgs";
