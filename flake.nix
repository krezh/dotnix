{
  ...
  inputs = {
    ...
    nix-cachyos-kernel = {
      url = "github:xddxdd/nix-cachyos-kernel/de22a442a9a7fc743e85c9979857d19692658040";
      inputs = {
    ...
    zen-browser = {
      url = "github:0xc000022070/zen-browser-flake/a12d482485d877cc066516ea256b435b209a1a8c";
      inputs = {
        nixpkgs.follows = "nixpkgs";
