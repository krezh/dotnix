{
  ...
  inputs = {
    ...
    nix-cachyos-kernel = {
      url = "github:xddxdd/nix-cachyos-kernel/29efd80e1929f7c8fc00d045a92b820609d725ca";
      inputs = {
    ...
    zen-browser = {
      url = "github:0xc000022070/zen-browser-flake/1c3a1fcacf97eb3792e9292e3afc0edbfcfa01d4";
      inputs = {
        nixpkgs.follows = "nixpkgs";
