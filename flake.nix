{
  ...
  inputs = {
    ...
    nix-cachyos-kernel = {
      url = "github:xddxdd/nix-cachyos-kernel/5a1c02fd24729fc624cc0615daa347f4b625c5c5";
      inputs = {
    ...
    zen-browser = {
      url = "github:0xc000022070/zen-browser-flake/ef5fe624be04120db77c08c5df6f75a6a4201517";
      inputs = {
        nixpkgs.follows = "nixpkgs";
